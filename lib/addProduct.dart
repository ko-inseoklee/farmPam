...
class _addProductPageState extends State<addProductPage> {
  ...
  String _farmName;
  String _farmLocationLat;
  String _farmLocationLong;
  ...
  void uploadProduct(String tempName, String price, String description, String category) async {
            ...
            return FlatButton(
              onPressed: () async {
                if (dropdownValue == 'Category') {
                  Scaffold.of(context)
                      .showSnackBar(SnackBar(content: Text('카테고리를 골라주세요.')));
                }
                else {
                  uploadProduct(
